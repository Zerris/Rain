package tarlgrenier.rain.graphics;
...
public class SpriteSheet {
	...
	// This code sets the sprite sheets
	public static SpriteSheet tiles = new SpriteSheet("/img/sheets/terrain.png", 256);
	public static SpriteSheet spawn_level = new SpriteSheet("/img/sheets/spawn_level.png", 48);
	public static SpriteSheet projectile_wizard = new SpriteSheet("/img/sheets/projectiles/wizard.png", 48);

	public static SpriteSheet player = new SpriteSheet("/img/sheets/player_m.png", 128, 96);
	...
	public static SpriteSheet dummy = new SpriteSheet("/img/sheets/king_cherno.png", 128, 96);
